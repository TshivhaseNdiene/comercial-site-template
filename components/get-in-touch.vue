<template>
   <div class="my-6 py-20" id="getintouch-section">
            <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-7xl bg-white  rounded-md text-[#333] font-[sans-serif]">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-3">Have some big idea or brand to develop and need help? Then reach out I'd love to hear about your project  and provide help.</p>
                    <div class="mt-12">
                        ...
                        <ul class="mt-3">
                            <li class="flex items-center">
                                ...
                                <a href="mailto:tshivhasendiene@gmail.com" class="text-[#007bff] text-sm ml-3">
                                    <small class="block">Email</small>
                                    <strong>tshivhasendiene@gmail.com</strong>
                                </a>
